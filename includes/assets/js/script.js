...
function updateEmail(emailClass){
	...
	$.post("includes/handlers/ajax/updateEmail.php", {username: userLoggedIn ,email: email }).done(function(m){
		$("."+emailClass).nextAll(".message").text(m);
	});
}
...
function Audio(){
	...
	this.setTrack = function(track){
		...
		this.audio.src = "includes/"+track.path;
	}
